...
<!--For those interested in documentinsg their collection in a similar manner, this table was generated from http://www.convertcsv.com/csv-to-html.htm-->
<!--First, download the excel sheet as a csv, simply open and resave using pandas. It'll add a serial number column. Then as, the images are also named using the serial number of the record it represents, 
simply load the csv onto the website
In Step 4: Create Custom Output via Template (optional)
